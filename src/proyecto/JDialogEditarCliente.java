 ...
 * @author DAM2Alu14
 */
public class JDialogEditarCliente extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JDialogEditarCliente.class.getName());
    ...
    public JDialogEditarCliente(java.awt.Frame parent, boolean modal) {
        //super(parent, modal);
